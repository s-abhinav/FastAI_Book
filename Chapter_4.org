...
#+begin_src jupyter-python :results file link :file "images/Chapter4/quadratic.svg" :var output_file="images/Chapter4/quadratic.svg"
  plot_function(
      lambda x: x**2 - 2*x + 1,
      title=r"$f(x) = x^2 - 2x + 1$",
...
*** Accuracy
#+begin_src jupyter-python :results value raw
...
#+begin_src jupyter-python :results file link :file "images/Chapter4/predictions.svg" :var output_file="images/Chatper4/predictions.svg"
  # Sample data
  time = torch.arange(0,20).float()
  speed = torch.randn(20)*3 + 0.75*(time-9.5)**2 + 1
